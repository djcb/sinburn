...
(let ( (sinburn-fg		"#dcdccc")
  ...
  (custom-theme-set-faces
    ...
    '(sinburn-primary-3 ((t (:foreground "#dfdfbf" :weight bold))))
    '(sinburn-primary-4 ((t (:foreground "#dca3a3" :weight bold))))
    '(sinburn-primary-5 ((t (:foreground "#94bff3" :weight bold))))
    ...
    '(sinburn-lowlight-1 ((t (:foreground "#606060"))))
    '(sinburn-lowlight-2 ((t (:foreground "#708070"))))
    ...
    '(erc-timestamp-face ((t (:inherit sinburn-green+1))))
    ...
    '(message-header-name ((t (:inherit sinburn-green+1))))
    '(message-header-other ((t (:inherit sinburn-lowlight-2))))
    '(message-header-to ((t (:inherit sinburn-primary-3))))
    '(message-header-from ((t (:inherit sinburn-orange))))
    '(message-header-cc ((t (:inherit sinburn-primary-3))))
    '(message-header-bcc ((t (:inherit sinburn-primary-3))))
    '(message-header-newsgroups ((t (:inherit sinburn-primary-1))))
    '(message-header-subject ((t (:inherit sinburn-primary-5))))
